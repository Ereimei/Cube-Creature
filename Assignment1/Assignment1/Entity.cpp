...
void Entity::rotate(float angle, bool up) {
	...
	if (up) {
		...
		this->up = glm::vec3(rotation * glm::vec4(this->up, 1));
		this->direction = glm::vec3(rotation * glm::vec4(this->direction, 1));
	}
	else {
		...
		this->right = glm::vec3(rotation * glm::vec4(this->right, 1));
		this->direction = glm::vec3(rotation * glm::vec4(this->direction, 1));
	}
}
